...
const transporter = nodemailer.createTransport({
  service: "Gmail",
  auth: {
    user: "cdyrving@gmail.com",
    pass: "dvzrovrijacuqotu",
  },
});
  ...
  const products = [
    {
      ...
      imgsrc: `./static/img/orange_juice.jpg`
    },
    {
    ...
    },
    {
      ...
      imgsrc: `./static/img/pineapple_juice.jpg`
    },
    {
...
app.post("/email", async (req, res) => {
  ...
  const sender = "Joe 2 Go <cdyrving@gmail.com>";
